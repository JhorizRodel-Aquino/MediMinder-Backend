...
def db_connection():
    connection = mysql.connector.connect(host="mediminder457.mysql.pythonanywhere-services.com", user="mediminder457", password="mediMINDERmySQLdb!!", database="mediminder457$mediminder_db")
    return connection
